...
<div class="logintop">    
    ...
    <br/>
  	...
  	<%
	    ...
	    <div style="text-align: center;">
	     <span style="font-size: 15px;color:white;font-weight: bold;">用户名或者密码错误</span>
	    </div>
    <%} %>
    ...
    <%} 
    	session.removeAttribute("pwd");//删除，否则界面一直有提示语
    %>
    	<%
    	//声明java代码块进行注册提示语的逻辑校验
    ...
    <form action="user" method="post">
    	<input type="hidden" name="oper" value="login"/><!--隐藏标签，根据ooper的值来进行相应的判断-->
    	<ul>
