...
<script type="text/javascript">
	...
	<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-19" data-genuitec-path="/Healthy_manager/WebRoot/main.jsp">
		<div id="btm" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-19" data-genuitec-path="/Healthy_manager/WebRoot/main.jsp">
			<div id="main">
				...
				<div id="content">
					...
					<div id="right">
						...
						<div id="demo">
							<div id="indemo">
								<div id="demo1">
									<a href="#"><img src="${url}/images/00000.jpg" border="0" width="310"
											height="210" /> </a>
									<a href="#"><img src="${url}/images/01.jpg" border="0" width="310"
											height="210" /> </a>
									<a href="#"><img src="${url}/images/02.jpg" border="0" width="310"
											height="210" /> </a>
									<a href="#"><img src="${url}/images/03.jpg" border="0" width="310"
											height="210" /> </a>
									<a href="#"><img src="${url}/images/00000.jpg" border="0" width="310"
											height="210" /> </a>
									<a href="#"><img src="${url}/images/01.jpg" border="0" width="310"
						...
						<ul>
							<li>
								<a href="http://www.hnist.cn/"><font size=2px; color==#A4A4A4>湖南理工学院主页</font> </a>
							</li>
							<li>
