...
$(document).ready(function() {
	...
	<BODY data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-3" data-genuitec-path="/Healthy_manager/WebRoot/back_login.jsp">
		<TABLE cellSpacing=0 cellPadding=0 width=651 align=center border=0 data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-3" data-genuitec-path="/Healthy_manager/WebRoot/back_login.jsp">
			<TBODY>
