...
<link rel="stylesheet" type="text/css" href="${url}/style/main.css"  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-17" data-genuitec-path="/Healthy_manager/WebRoot/header.jsp"/>
